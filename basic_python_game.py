...
def bolsa():
    ...
    match use_item:
        ...
        case 1:
            ...
            use = int(input(f"voçê possui {player.l_pocao} {'poções' if player.l_pocao > 1 else 'poção'} de vida gostaria de usar 1?\n1 - sim\n2 - não\n: "))
        ...
        case 2:
            ...
            use = int(input(f"voçê possui {player.m_pocao} {'poções' if player.m_pocao > 1 else 'poção'} de mana gostaria de usar 1?\n1 - sim\n2 - não\n: "))
...
def attacks():
    ...
    print("============================ ATAQUES ============================")
    #golpe de espada, golpe de espada embuida com mana, bola de fogo, lança-chamas, tsunami, jato de agua
    ...
    match move:
        ...
        case 6:
            ...
            damage = max(75 * player.level, player.level * ( ( (player.inteligencia * (player.mana / 4.5)) * PSI)) - enemy.defense)
...
def defense():
    ...
    #double defense, cura, parry, contra-ataque
    ...
    if enemy.name == "DRAGÃO":
        ...
        match ea:
            ...
            case 1:
                ...
                damage = int((enemy.force + enemy.intel) - player.defesa)

                player.atual_life -= damage

                print(f"O dragão usou LIGHTNING STRIKE causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
            ...
            case 2:
                ...
                damage = int((enemy.life / 10) + (enemy.defense / 25) - player.defesa)

                player.atual_life -= damage

                print(f"O dragão usou INVESTIDA causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
            ...
            case 3:
                ...
                damage = int((enemy.force / 4.5) - player.defesa)

                player.atual_life -= damage

                print(f"O dragão usou ARRANHÃO causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
        ...
        match ea:
            ...
            case 1:
                ...
                damage = int(enemy.force * (enemy.life / 2.5) - player.defesa)
                player.atual_life -= damage

                print(f"O slime usou TIRO ÁCIDO causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
            ...
            case 2:
                ...
                damage = int((enemy.life * enemy.defense + enemy.force) - player.defesa)
                player.atual_life -= damage

                print(f"O slime usou INVESTIDA causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
        ...
        match ea:
            ...
            case 1:
                ...
                player.atual_life -= enemy.intel
                enemy.life += enemy.intel
            ...
            case 2:
                ...
                damage = enemy.force * 2.5
                player.atual_life -= damage

                print(f"O goblin usou APUNHALADA causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
            ...
            case 3:
                ...
                damage = enemy.force + enemy.intel
                player.atual_life -= damage

                print(f"O goblin usou CHUTE causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
        ...
        match ea:
            ...
            case 1:
                ...
                print(f"O esqueleto usou FLECHADA causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
            ...
            case 2:
                ...
                if broken == 1:
                    ...
                    print(f"O esqueleto usou tanto o arco que ele quebrou então está usando SOCO e causou {damage} de ao jogador {player.nome}")
                    input("Pressione ENTER para continuar ...")
                    broken = 0
                
                else:

                    print(f"O esqueleto usou SOCO causando {damage} de dano ao jogador {player.nome}")
                    input("Pressione ENTER para continuar ...")
            ...
            case 3:
                ...
                damage = enemy.defense + enemy.force
                player.atual_life -= damage

                print(f"O esqueleto usou SCRATCH causando {damage} de dano ao jogador {player.nome}")
                input("Pressione ENTER para continuar ...")
